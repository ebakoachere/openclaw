...
import { runClosePositionPartial } from "./index.js";
import {
  BffEgressViolation,
  createBffFetch,
...
describe("vctraderai-close-position-partial egress allowlist", () => {
  ...
  it("accepts this plugin own workspace-scoped path", () => {
    expect(`/api/v1/workspaces/${WORKSPACE_ID}/live/positions/pos-9/agent-partial-close`).toMatch(
      VCTRADERAI_BFF_ALLOWLIST_PATH_PATTERN,
    );
  });
