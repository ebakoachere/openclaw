...
import { runSetTrailingStop } from "./index.js";
import {
  BffEgressViolation,
  createBffFetch,
...
describe("vctraderai-set-trailing-stop egress allowlist", () => {
  ...
  it("accepts this plugin own workspace-scoped path", () => {
    expect(`/api/v1/workspaces/${WORKSPACE_ID}/live/positions/pos-9/agent-trailing-stop`).toMatch(
      VCTRADERAI_BFF_ALLOWLIST_PATH_PATTERN,
    );
  });
