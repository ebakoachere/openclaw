...
import { runGetRiskManager } from "./index.js";
import {
  BffEgressViolation,
  createBffFetch,
...
describe("vctraderai-get-risk-manager egress allowlist", () => {
  ...
  it("surfaces an aborted fetch via AbortSignal", async () => {
    ...
    controller.abort();
    await expect(
      runGetRiskManager({ risk_manager_id: "rm-1" }, { fetchImpl }, controller.signal),
