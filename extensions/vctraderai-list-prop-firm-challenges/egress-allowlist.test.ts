...
import { runListPropFirmChallenges } from "./index.js";
import {
  BffEgressViolation,
  createBffFetch,
...
describe("vctraderai-list-prop-firm-challenges egress allowlist", () => {
  ...
  it("surfaces an aborted fetch via AbortSignal", async () => {
    ...
    controller.abort();
    await expect(
      runListPropFirmChallenges({}, { fetchImpl }, controller.signal),
