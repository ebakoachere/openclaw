...
import { runGetStrategySource } from "./index.js";
import {
  BffEgressViolation,
  createBffFetch,
...
describe("vctraderai-get-strategy-source egress allowlist", () => {
  ...
  it("surfaces an aborted fetch via AbortSignal", async () => {
    ...
    controller.abort();
    await expect(
      runGetStrategySource({ strategy_id: "str-1" }, { fetchImpl }, controller.signal),
